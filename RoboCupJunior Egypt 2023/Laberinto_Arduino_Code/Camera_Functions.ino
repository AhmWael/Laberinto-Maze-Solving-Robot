void read_Cameras(int X_Pos, int Y_Pos) {
  // This function reads the camera pins and compares them to predetermined values that match the ones sent by the OpenMV camera
  // and it saves that this tile has a victim to prevent the deployment of kits more than once 
